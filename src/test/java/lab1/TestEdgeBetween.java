...
public class TestEdgeBetween {
  ...
  @Test public void outOfEdge() {
	    Graph<Integer> g = new SimpleGraph(10, new int[][] {{4, 7}});
	    assertThat(Lab1.edgeBetween(g, 20, 14)).isFalse();
	    assertThat(Lab1.edgeBetween(g, 7, 4)).isFalse();
	    assertThat(Lab1.edgeBetween(g, 4, 7)).isTrue();
	  }

  @Test public void negativEdge() {
	    Graph<Integer> g = new SimpleGraph(10, new int[][] {{10, 5}});
	    assertThat(Lab1.edgeBetween(g, -10, -1)).isFalse();
	    assertThat(Lab1.edgeBetween(g, -4, 4)).isFalse();
	    assertThat(Lab1.edgeBetween(g, 10, 5)).isTrue();
	    assertThat(Lab1.edgeBetween(g, 5, 10)).isFalse();
	  }
